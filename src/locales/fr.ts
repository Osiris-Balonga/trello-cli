export default {
  ...
  cli: {
    ...
    subcommands: {
      auth: {
        ...
        github: 'Méthodes d\'authentification GitHub',
        githubPat: 'S\'authentifier avec un Personal Access Token',
        githubOauth: 'S\'authentifier via GitHub Device Flow',
  ...
  auth: {
    ...
    status: {
      ...
      runGitHubAuth: 'Exécutez : tt auth github pat',
      mode: 'Mode : {{mode}}',
      apiKey: 'Clé API : {{key}}...',
    ...
    logout: {
      ...
      confirmProviders: 'De quels providers voulez-vous vous déconnecter ?',
      trelloSuccess: 'Credentials Trello supprimés.',
      githubSuccess: 'Credentials GitHub supprimés.',
    },
    github: {
      validating: 'Validation du token...',
      validated: 'Token validé',
      validationFailed: 'Échec de la validation du token',
      pat: {
        title: 'Authentification GitHub Personal Access Token',
        instructions: 'Obtenez votre PAT sur : https://github.com/settings/tokens',
        scopeHint: 'Scopes requis : repo (pour les repos privés) ou public_repo (publics uniquement)',
        enterToken: 'Entrez votre Personal Access Token :',
        invalidToken: 'Format de token invalide. Doit commencer par "ghp_" ou "github_pat_"',
        success: 'GitHub PAT configuré avec succès',
      },
      oauth: {
        title: 'Authentification GitHub Device Flow',
        requestingCode: 'Demande du code d\'appareil...',
        instructions: '1. Allez sur : {{url}}\n2. Entrez ce code : {{code}}\n3. Autorisez l\'application',
        waitingAuth: 'En attente d\'autorisation...',
        polling: 'Vérification du statut d\'autorisation...',
        success: 'GitHub OAuth configuré avec succès !',
        expired: 'Code d\'appareil expiré. Veuillez réessayer.',
        accessDenied: 'Accès refusé. Veuillez réessayer.',
        failed: 'Échec de l\'authentification : {{error}}',
      },
      status: {
        title: 'Statut d\'authentification GitHub',
        authenticated: 'Authentifié',
        notAuthenticated: 'Non authentifié',
        mode: 'Mode : {{mode}}',
        token: 'Token : {{token}}...',
        runAuth: 'Exécutez : tt auth github pat',
      },
    },
  },
  ...
  init: {
    ...
    github: {
      fetching: 'Récupération de vos dépôts...',
      loaded: 'Dépôts chargés',
      noRepos: 'Aucun dépôt trouvé. Créez d\'abord un dépôt sur GitHub.',
      selectRepo: 'Sélectionnez un dépôt :',
      fetchingLabels: 'Récupération des labels du dépôt...',
      columnConfig: 'Configuration des colonnes',
      columnExplanation: 'GitHub Issues utilise des labels pour simuler les colonnes/états de workflow.',
      useDefaultColumns: 'Utiliser la configuration par défaut ? (À faire, En cours, Terminé)',
      selectTodoLabel: 'Sélectionnez le label pour la colonne "À faire" :',
      selectDoingLabel: 'Sélectionnez le label pour la colonne "En cours" :',
      selectDoneLabel: 'Sélectionnez le label pour la colonne "Terminé" :',
      doneUsesClosed: 'Utiliser les issues fermées pour "Terminé" ? (recommandé)',
      createNewLabel: '+ Créer un nouveau label',
      enterLabelName: 'Entrez le nom du label :',
      createMissingLabels: 'Créer les labels manquants sur GitHub ?',
      labelsCreationNote: 'Les labels seront créés lorsque vous déplacerez une carte vers cette colonne.',
      columnsCached: 'Colonnes configurées : {{count}}',
    },
  },
