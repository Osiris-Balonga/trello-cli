export default {
  ...
  display: {
    ...
    filteredView: 'Filtered: your cards only',
  },
  ...
  cli: {
    ...
    subcommands: {
      auth: {
        ...
        github: 'GitHub authentication methods',
        githubPat: 'Authenticate with Personal Access Token',
        githubOauth: 'Authenticate via GitHub Device Flow',
  ...
  auth: {
    ...
    status: {
      ...
      runGitHubAuth: 'Run: tt auth github pat',
      mode: 'Mode: {{mode}}',
      apiKey: 'API Key: {{key}}...',
    ...
    logout: {
      ...
      confirmProviders: 'Which providers do you want to logout from?',
      trelloSuccess: 'Trello credentials removed.',
      githubSuccess: 'GitHub credentials removed.',
    },
    github: {
      ...
      pat: {
        title: 'GitHub Personal Access Token Authentication',
        instructions: 'Get your PAT from: https://github.com/settings/tokens',
        scopeHint: 'Required scopes: repo (for private repos) or public_repo (for public only)',
        enterToken: 'Enter your Personal Access Token:',
        invalidToken: 'Invalid token format. Must start with "ghp_" or "github_pat_"',
        success: 'GitHub PAT configured successfully',
      },
      oauth: {
        title: 'GitHub Device Flow Authentication',
        requestingCode: 'Requesting device code...',
        instructions: '1. Go to: {{url}}\n2. Enter this code: {{code}}\n3. Authorize the application',
        waitingAuth: 'Waiting for authorization...',
        polling: 'Checking authorization status...',
        success: 'GitHub OAuth configured successfully!',
      ...
      status: {
        ...
        mode: 'Mode: {{mode}}',
        token: 'Token: {{token}}...',
        runAuth: 'Run: tt auth github pat',
      },
    },
  },
  ...
  init: {
    ...
    github: {
      fetching: 'Fetching your repositories...',
      loaded: 'Repositories loaded',
      noRepos: 'No repositories found. Create a repository on GitHub first.',
      selectRepo: 'Select a repository:',
      fetchingLabels: 'Fetching repository labels...',
      columnConfig: 'Column Configuration',
      columnExplanation: 'GitHub Issues uses labels to simulate columns/workflow states.',
      useDefaultColumns: 'Use default column configuration? (To Do, In Progress, Done)',
      selectTodoLabel: 'Select label for "To Do" column:',
      selectDoingLabel: 'Select label for "In Progress" column:',
      selectDoneLabel: 'Select label for "Done" column:',
      doneUsesClosed: 'Use closed issues for "Done"? (recommended)',
      createNewLabel: '+ Create new label',
      enterLabelName: 'Enter label name:',
      createMissingLabels: 'Create missing labels on GitHub?',
      labelsCreationNote: 'Labels will be created when you first move a card to that column.',
      columnsCached: 'Columns configured: {{count}}',
    },
  },
